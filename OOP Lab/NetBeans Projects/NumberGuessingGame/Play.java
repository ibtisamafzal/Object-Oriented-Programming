...
public class Play extends JPanel {
    ...
    private void createGUI() {
        ...
        final JLabel playScore, gameText, minMaxImage , mysteryNumber, statusImage, enterButton, continueButton, backButton;
        final JTextField inputText;
        final JPanel gridPanel;
        final int random = randomNumber.generateNumber(); // generates a random number
